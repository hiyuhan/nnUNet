...
class ExperimentPlanner3D_v21_customTargetSpacing_311(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "nnUNetData_plans_v2.1_trgSp_311"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_trgSp_311_plans_3D.pkl")

    def get_target_spacing(self):
        # simply return the desired spacing as np.array
        return np.array([3., 1., 1.]) # make sure this is float!!!! Not int!
